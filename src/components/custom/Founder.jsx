          ...
          <div className="lg:col-span-2 lg:order-1 order-2 flex justify-center items-start">
            <div className="md:mt-16 mt-8 xl:block flex flex-col items-center justify-center">
              ...
              <p className="xl:mb-10 mb-5 xl:ml-[15%] lg:text-left text-center lg:text-base text-sm">
                ...
                pride that I welcome you to Befog. As the founder of this
                innovative IT startup, I am excited to share our vision and the
                journey that has brought us here. At Befog, we are dedicated to
                pushing the boundaries of technology to deliver solutions that
                not only meet the needs of today but anticipate the challenges
                of tomorrow.
                <br/><br/>
                Our story began with a simple
                yet profound belief: technology holds the key to transforming
                businesses and enriching lives. With this conviction at our
                core, we have assembled a team of exceptional individuals who
                share a common passion for innovation and excellence. Together,
                we are committed to creating a future where technology empowers
                organizations to achieve their fullest potential.
              </p>
              <Button className="xl:ml-[15%] w-fit">Learn More</Button>
            </div>
          </div>
